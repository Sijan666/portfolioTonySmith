...
const Error = () => {
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-[#050505] overflow-hidden selection:bg-white/10">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center p-10 md:p-16 rounded-3xl bg-white/[0.02] border border-white/[0.05] shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] backdrop-blur-2xl text-center max-w-lg mx-4">
        
        {/* Massive Glowing 404 Text */}
        <h1 className="text-[120px] md:text-[150px] font-bold leading-none tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white to-white/20 drop-shadow-[0_0_40px_rgba(255,255,255,0.05)] select-none">
          404
        </h1>
        
        {/* Divider Line */}
        <div className="w-12 h-[1px] bg-white/20 my-6"></div>
